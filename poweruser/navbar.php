...
<li class="nav-item">
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Jenis Senarai Permohonan</h6>
            <a class="collapse-item" href="index.html">Peromohonan Tertangguh</a>
            <a class="collapse-item" href="index.html">Permohonan Diterima</a>
            <a class="collapse-item" href="index.html">Permohonan Ditolak</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Jenis Kuarters</h6>
            <a class="collapse-item" href="index.html">Kuarters A</a>
            <a class="collapse-item" href="index.html">Kuarters B</a>
            <a class="collapse-item" href="index.html">Kuarters C</a>
            <a class="collapse-item" href="index.html">Kuarters D</a>
        </div>
    </div>
</li>
